...
<!--    <input type="file" webkitdirectory multiple="multiple" id="minIoFile" ref="minIoFile" v-show="false"-->
<!--           @change="getFile">-->
    <!--    <el-button v-if="fileList.length>0" type="primary" @click="upload">上传</el-button>-->
    <!--    <el-button type="primary" @click="download">下载</el-button>-->
<!--    <el-button type="primary" @click="upload">shangchuan</el-button>-->
  ...
  export default {
    ...
    methods: {
      ...
      upload() {
        ...
        var file = 'F:\\project\\aspose-words-14.9.0-jdk16.jar'

// Make a bucket called europetrip.
//         minioClient.makeBucket('img', 'us-east-1', function (err) {
//           if (err) return console.log(err)
        ...
        minioClient.fPutObject('img', 'aspose-words-14.9.0-jdk16.jar', file, metaData, function (err, etag) {
          if (err) return console.log(err)
